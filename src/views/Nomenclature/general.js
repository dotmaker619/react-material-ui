...
const orderData = {
  headerRow: ["Номер", "Имя клиента", "Дата заказа", "Сумма заказа", "Тип заказа", "описание", "действие"],
  footerRow: ["Номер", "Имя клиента", "Дата заказа", "Сумма заказа", "Тип заказа", "описание", "действие"],
  dataRows: [
...
const profileData = {
  dataArray: [
    ["sairam@gmail.com","Sairam", "Reddy", "Gudimetla","82032453","New Delhi, No32"],
  ]
};
const customerData = {
  headerRow: ["Номер", "Имя клиента", "Почта", "Город", "Сумма сделок", "действие"],
  footerRow: ["Номер", "Имя клиента", "Почта", "Город", "Сумма сделок", "действие"],
  dataRows: [
    ["1","Tiger Nixon", "serhiibalyskyi@gmail.com","Kyiv","22340$"],
    ["2","Garrett Winters", "sairam@gmail.com","New Delhi", "18095$"],
    ["3","Tiger Nixon", "serhiibalyskyi@gmail.com","Kyiv","22340$"],
    ["4","Garrett Winters", "sairam@gmail.com","New Delhi", "18095$"],
    ["5","Tiger Nixon", "serhiibalyskyi@gmail.com","Kyiv","22340$"],
    ["6","Garrett Winters", "sairam@gmail.com","New Delhi", "18095$"],
    ["7","Tiger Nixon", "serhiibalyskyi@gmail.com","Kyiv","22340$"],
    ["8","Garrett Winters", "sairam@gmail.com","New Delhi", "18095$"],
  ]
};

const productData = {
  headerRow: ["Tовара", "цвет", "Размер", "Цена", "Компания", "действие"],
  footerRow: ["Tовара", "цвет", "Размер", "Цена", "Компания", "действие"],
  dataRows: [
    ["Jacket", "Red","M","22340$", "Guru", "assets/img/product1.jpg"],
    ["Short Pants", "White","C", "18095$", "Japerson", "../../assets/img/product2.jpg"],
    ["Skirt", "Blue","A","22340$", "New Asia", "../../assets/img/product3.jpg"],
  ]
};
